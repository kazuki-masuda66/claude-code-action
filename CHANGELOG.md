...
## Fork Changes (kazuki-masuda66/claude-code-action@beta)
...
- **Updated Base Action**: Uses `kazuki-masuda66/claude-code-base-action@beta` which includes OAuth credential handling
